	...
	$(document).ready(function(){
		...
		$("#boardCategory>li").each(function(){
			$(this).click(function(){	//this가 선택한 <li>
				category = $(this).text();
		        //alert("선택됨"+category);
				$("#boardCategory>li").removeAttr("class"); //id가 boardCategory인 컴포넌트의 하위 엘리먼트 li태그의 모든 class적용
				...
				data: ajax요청할 때 컨트롤러로 넘길 데이터(category)
				success: 요청이 성공하고 호출되는 함수
				*/
				$.ajax({
					url:"/mvc/board/ajax_list.do",
					type:"get",
					data:{"category":category},
					success:function(data){
						mydata = ""; //데이터를 누적할 변수
						//조회환 json데이터(ArrayList<BoardVO) 갯수만큼 출력
						//Ajax는 데이터만 가져오기 때문에 뷰에 연결하는 작업을 success인 경우 실행할 함수에서 처리한다.
						for(i=0;i<data.length;i++){
							//mydata = mydata + data[i].title + "," +data[i].write;
						...
						//alert(mydata);
						//데이터 전송이 성공하면 어떤 방법으로 뷰를 만들 것이지 명시
						//결과를 테이블에 추가
						$("#mydatalist").empty();
				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel"
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="/mvc/images/multi1.jpg" alt="Image"
								style="width: 600px; height: 300px">

						</div>

						<div class="item">
							<img src="/mvc/images/multi2.jpg" alt="Image"
								style="width: 800px; height: 300px">

						</div>
						<div class="item">
							<img src="/mvc/images/multi3.jpg" alt="Image"
								style="width: 600px; height: 300px">
