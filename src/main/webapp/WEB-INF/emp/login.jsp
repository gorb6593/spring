...
<body>
	<form name="login_frm" action="/mvc/emp/login.do" method="post">
															...
															<tr>
																<td>
																	<table cellpadding="0" cellspacing="0" border=0>
																		...
																		<tr>
																			<td colspan=3><img
																				src="/mvc/images/page_login.gif"></td>
																		</tr>
																		<tr>
																			<td height=25></td>
																		</tr>
																		<tr>
																			<td background="/mvc/images/inputBg.gif"><img
																				src="/mvc/images/login_id.gif"></td>
																			<td background="/mvc/images/inputBg.gif"><input
																				type="text" name="id" size="15" class="grayinput"
																				tabindex=1 style="width: 156;"
																				 value="<%= id%>"></td>
																			<td rowspan=3 style="padding-left: 10" valign=bottom>
																			<input
																				type='image' src="/mvc/images/btn_login.gif"
																		...
																		<tr>
																			<td background="/mvc/images/inputBg.gif"><img
																				src="/mvc/images/login_pass.gif"></td>
																			<td background="/mvc/images/inputBg.gif"><input
