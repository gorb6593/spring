  	...
  	$(document).ready(function(){
  		$("#id").on("keyup", function(){
  			/*
  				...
  				data => Ajax로 요청을 실행하기 위해 외부에서 입력받아야 하는 값이 있는 경우 전달
  						json형식으로 만들어서 보낸다.
  						json형식 : {"name":"value","value",.....}
  			...
  			*/
  			...
  			//자바스크립스에서 동기방식으로 요청하기 - 기존에 우리가 웹을 요청해서 응답받아 사용하는 방법
  			//location.href="mvc/emp/idcheck.do?id="+$("#id").val(); ->불가능
  		});		
  	});
	...
	<div class="container">
		...
		<div>
				<form role="form" class="form-horizontal"
					action="/mvc/emp/insert.do" method="POST" 
					name="myform">
					<fieldset>
						<div id="legend">
